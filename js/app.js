...
function personal_inquiry() {
    ...
    sNavigator.pushPage("personal_inquiry.html", options);
}
...
function page_contact_map() {
    ...
    sNavigator.pushPage("page_contact_map.html", options);
}
...
function inquire_acc() {
    ...
    sNavigator.pushPage("inquire_acc.html", options);
}
function page_family() {
...
function page_criminal_defense_info() {
    ...
    sNavigator.pushPage("page_criminal_defense_info.html", options);
}
function page_know_your_rights() {
    ...
    sNavigator.pushPage("page_know_your_rights.html", options);
}
function page_DWI_Defense() {
    ...
    sNavigator.pushPage("page_DWI_Defense.html", options);
}
function page_DWI_info() {
    ...
    sNavigator.pushPage("page_DWI_info.html", options);
}
function page_arrested() {
    ...
    sNavigator.pushPage("page_arrested.html", options);
}
function page_being_arrested() {
    ...
    sNavigator.pushPage("page_being_arrested.html", options);
}

function page_divorce() {
    var options = {
        animation: 'slide',
        onTransitionEnd: function () {
    ...
    sNavigator.pushPage("page_divorce.html", options);
}
function page_custody() {
    var options = {
        animation: 'slide',
        onTransitionEnd: function () {
    ...
    sNavigator.pushPage("page_custody.html", options);
}

function page_child_and_sous_support() {
    var options = {
        animation: 'slide',
        onTransitionEnd: function () {
...
function page_child() {
    ...
    sNavigator.pushPage("page_child.html", options);
}
function page_spousal() {
    var options = {
        animation: 'slide',
        onTransitionEnd: function () {
    ...
    sNavigator.pushPage("page_spousal.html", options);
}
function page_child_and_sous_support() {
    var options = {
        animation: 'slide',
